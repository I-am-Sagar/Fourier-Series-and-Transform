...
function draw() {
    ...
    line (300, -180, 300, 180);   //y axis for sine wave (Oscillating point)
...
function keyPressed() { // Reset everything when Q is pressed
    if (key == 'q' || key == 'Q') {
        time = 0; wave = []; state = 0;
    }
}
...
function singlePhasor() {
    ...
    stroke(10, 82, 117, 150); strokeWeight(3); noFill();
    ...
    translate(300, 0); stroke(255, 100)
